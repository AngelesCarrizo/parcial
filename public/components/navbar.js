export const navBar = ()=>{
    ...
    const routes = [
        {link:"http://127.0.0.1:3001/index.html", name:"Home"},
        {link:"http://127.0.0.1:3001/pages/ingredientes/", name:"Ingredientes"},
        {link:"http://127.0.0.1:3001/pages/recetas/", name:"Recetas"}
    ]
    return `
